...
const Projects = () => {
    ...
    return (
        <>
            <section className="pt-15 px-5 bg-gray-950 text-white" id='experience'>
                ...
                <div className="projects">
                    <div className="selectors flex justify-center gap-2 md:gap-5">
                    ...
                    <div className="result w-[98%] mx-auto gap-5 md:flex justify px-2 my-3 items-center py-5">
                        {projects.map((project, index) => {
                            return (
                                <div className="container relative  md:w-[33%] h-[450px] my-5 md:my-0 border border-gray-600 rounded p-3">
