            ...
            <section className={`${theme}`}>
                <div id="home" className="mt-15 flex flex-col md:flex-row-reverse items-center  relative banner bg-gray-300 bg-gray-950 text-white">
                    ...
                    <div className="absolute right-2 md:right-4 top-70 md:top-40 flex flex-col gap-4 items-end">
                        ...
                        {/* <a className="group dark:bg-gray-800 rounded-full h-[45px]  cursor-pointer text-gray-300 transition-all duration-300 w-[45px] flex flex-row-reverse items-center" onClick={handleTheme}>
                            <DarkModeOutlinedIcon className="mr-2.5 text-xl" />
